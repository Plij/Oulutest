...
function RemoveHighlights(ents){
    for (i in ents){
        ents[i].RemoveComponent('EC_Highlight', 'MySpecialHighlight', 'EcEditorHighlight');
    }
...
function CheckPlacement(enti){
    ...
    if(ent.dynamiccomponent.name == "Prop" || ent.dynamiccomponent.name == "prop"){
        ...
        RemoveHighlights(scene.GetEntitiesWithComponent('EC_Highlight', 'MySpecialHighlight', 'EcEditorHighlight'));
